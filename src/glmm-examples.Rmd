...
```{r initialize, cache=FALSE, echo=FALSE, message=FALSE}
packageList = c("ggplot2", # Plotting
                "sjPlot", # Tables for model outputs
                "cowplot", # Arrange plots 
                "ggbeeswarm", # Beeswarm plots
...
`r ConstructModelTable(lm1, show.fstat = TRUE)`
...
<summary>**Expand code**</summary>
<p>
```{r compare_F_stat_stub, eval=FALSE}
...
`r ConstructModelTable(glm1, show.r2 = FALSE)`
...
`r ConstructModelTable(glm2, show.r2 = FALSE)`
...
`r ConstructModelTable(glm3, show.r2 = FALSE)`
...
`r ConstructModelTable(glmm, show.r2 = FALSE, show.icc = FALSE)`
